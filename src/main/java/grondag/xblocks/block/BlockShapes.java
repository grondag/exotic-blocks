...
public class BlockShapes {
	...
	public static void init() {
		...
		register(Blocks.SNOW_BLOCK, "snow_block", McTextures.SNOW, true);
	}
	...
	public static void register(
		...
		BlockHelper.insetPanel(name + "_prismarine", blockIn, paintTop, paintSide, glow, 0);
		BlockHelper.flatPanel(name + "_prismarine", blockIn, paintTop, glow, 0);
		BlockHelper.squareInsetColumn(name + "_prismarine", blockIn, paintTop, paintSide, paintSide, glow, coarse ? 2 : 3);
		...
		BlockHelper.flatPanel(name + "_glowstone", blockIn, paintTop, glow, 0);
		...
		BlockHelper.insetPanel(name + "_lamp", blockIn, paintTop, paintSide, glow, 15);
		BlockHelper.flatPanel(name + "_lamp", blockIn, paintTop, glow, 15);
		BlockHelper.cappedSquareColumn(name + "_lamp", blockIn, paintTop, paintSide, paintSide, glow, 15);
		BlockHelper.cutRoundColumn(name + "_lamp", blockIn, paintTop, paintSide, paintSide, glow, 15);
	}
}
