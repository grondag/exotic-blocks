...
public class Granite {
    ...
    public static void init() {
        ...
        XmBlockRegistry.addBlock(Blocks.GRANITE, PrimitiveStateFunction.ofDefaultState(
                Cube.INSTANCE.newState()
                    .paintAll(GRANITE_RAW)
                    .releaseToImmutable()));
        
        XmBlockRegistry.addBlock(Blocks.POLISHED_GRANITE, PrimitiveStateFunction.ofDefaultState(
                Cube.INSTANCE.newState()
