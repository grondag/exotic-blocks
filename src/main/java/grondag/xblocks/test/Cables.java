...
public class Cables {
    ...
    static final XmSurface SURFACE_SIDE = SURFACES.get(0);
    static final XmSurface SURFACE_END = SURFACES.get(1);
    static final XmSurface SURFACE_CONNECTOR = SURFACES.get(2);
    
    static final XmPaint PAINT_SIDE = XmPaint.finder()
            .textureDepth(1)
            .texture(0, XmTextures.TILE_NOISE_LIGHT)
            .textureColor(0, 0xFF808090)
            .find();
    
    static final XmPaint PAINT_END = XmPaint.finder()
            .textureDepth(1)
            .texture(0, XmTextures.TILE_NOISE_SUBTLE)
            .textureColor(0, 0xFF303030)
            .find();
    
    static final XmPaint PAINT_CONNECTOR = XmPaint.finder()
            .textureDepth(1)
            .texture(0, XmTextures.TILE_NOISE_SUBTLE)
    ...
    private static final SimplePrimitive PRIMITIVE = SimplePrimitive.builder()
            ...
            .polyFactory(Cables::polyFactory)
            .primitiveBitCount(6)
            .simpleJoin(true)
            .build(Xb.idString("square_cable_test"));
    
    static final PrimitiveStateMutator MODEL_STATE_UPDATE = (modelState, xmBlockState, world, pos, neighbors, refreshFromWorld) -> {
    ...
    public static void init() {
        Identifier id = Xb.id("square_cable_test");
